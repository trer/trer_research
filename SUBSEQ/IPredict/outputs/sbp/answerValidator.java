...
".consequent.mapped.txt";//"answers.consequents.Fifa.txt";
	        ...
	        try {
	            ...
	            while((line = bufferedReader.readLine()) != null) {
	                try {
                        ...
                        if (i>4) {
                            System.out.println("Could not parse the following line, skipping to next");
                            System.out.println(line);
                        } else {
                            i = i + 1;
                        }
	        ...
	        if (consequents.size() != answersBWT.size()){
	        System.out.println(consequents.size());
	        System.out.println(answersBWT.size());
	        System.out.println("Answers are missing fron one or the other file"); return;
	        }
