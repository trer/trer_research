...
public class DatabaseHelper {
	...
	public void loadDataset(String fileName, int maxCount) {
		...
		try {
			...
			System.out.println(datasetFormat);
	...
	private void loadPredefinedDataset(Format format, int maxCount) {
		...
		try {
			...
			case TINYSHAKESPEARE:
			    database.loadFileLargeTextFormatAsCharacter(fileToPath("tiny_shakespeare.txt"), maxCount, Profile.paramInt("sequenceMinSize"), Profile.paramInt("sequenceMaxSize"));
			    break;
			default:
